...
class DDPG(object):
    ...
    def setup(self, nb_states, nb_actions):
        ...
        actor  = Actor (nb_states, nb_actions, hidden1 = model_args['hidden1'], hidden2 = model_args['hidden2'] , layer_norm = model_args['layer_norm'])
        critic = Critic(nb_states, nb_actions,hidden1 = model_args['hidden1'], hidden2 = model_args['hidden2'] , layer_norm = model_args['layer_norm'])
        ...
        self.memory = Memory(self.buffer_size, (nb_actions,), (nb_states,), self.with_cuda)
