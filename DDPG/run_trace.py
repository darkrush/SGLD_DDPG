...
if __name__ == "__main__":
    ...
    #Training args
    parser.add_argument('--nb-rollout-steps', default=200, type=int, help='number rollout steps')
    parser.add_argument('--nb-train-steps', default=5000, type=int, help='number train steps')
